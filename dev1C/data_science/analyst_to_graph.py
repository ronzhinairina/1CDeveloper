...
from analyst import MultiprocessorHandler
import matplotlib
...
# Graph(data.salary_by_years, "Средняя З/П", "all_salaries").get_vertical_graph()
# Graph(data.count_by_years, "Количество вакансий", "all_count").get_vertical_graph()
# Graph(data.salary_by_cities, "Уровень З/П", "city_all_salaries").get_horizontal_graph()
Graph(data.count_by_cities, "ффф", "city_all_count").add_pie_sublot()
